...
class UserAchievementsController extends StateNotifier<UserAchievementsState> {
  final FirebaseAuth _auth;
  final FirebaseFirestore _firestore;
  final String role;

  UserAchievementsController(this._auth, this._firestore, this.role)
  ...
  Future<void> _load() async {
    try {
      ...
      final int xp = _toInt(data['xp']);
      final int level = _toInt(data['xpLevel']);
      ...
      final unlockedMap = Map<String, dynamic>.from(data['achievements'] ?? {});
...
final userAchievementsControllerProvider = StateNotifierProvider.family<
