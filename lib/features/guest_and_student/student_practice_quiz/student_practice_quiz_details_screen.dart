...
class StudentPracticeQuizDetailsScreen extends StatefulWidget {
  final String quizId;
  final String title;
  final List<Map<String, dynamic>> questions;

  const StudentPracticeQuizDetailsScreen({
    super.key,
  ...
  @override
  State<StudentPracticeQuizDetailsScreen> createState() =>
      _StudentPracticeQuizDetailsScreenState();
}

class _StudentPracticeQuizDetailsScreenState
    extends State<StudentPracticeQuizDetailsScreen> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final correctIndex = (question["correctIndex"] ?? 0) as int;
    final userChoice = userAnswers[currentIndex];

    return Scaffold(
      backgroundColor: AppColors.primaryDark,
      appBar: CommonRoundedAppBar(title: "Practice Quiz Details"),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _summaryPill("Correct", correct, Colors.green.shade100),
              _summaryPill("Wrong", wrong, Colors.red.shade200),
              _summaryPill(
                "Total",
  ...
  Widget _buildQuestionCard({
    ...
    final String explanation = (question["description"] ?? "").toString();
      ...
      child: Column(
        ...
        children: [
          ...
          ...List.generate(options.length, (i) {
            final bool isCorrect = (i == correctChoice);
        ...
        children: [
          Expanded(
            child: GestureDetector(
              onTap: isFirst ? null : () => setState(() => currentIndex--),
              child: Container(
          ...
          Expanded(
            child: GestureDetector(
              onTap: isLast ? null : () => setState(() => currentIndex++),
              child: Container(
                padding: const EdgeInsets.symmetric(vertical: 14),
                decoration: BoxDecoration(
