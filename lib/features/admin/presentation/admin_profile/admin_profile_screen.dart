...
import '../dashboard/controller/admin_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        ...
        /// 🔥 Show skeleton loader if admin data is loading
        if (state.loading || state.admin == null) {
              ...
              SafeArea(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      /// ⭐ REAL DATA APPLIED HERE
                      ProfileHeader(
                        isLoading: state.loading,
                        name: state.admin?.fullName,
                        email: state.admin?.email,
                        imageUrl: state.admin?.profileImage,
                      ),
